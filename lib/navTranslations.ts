  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        descriptions: {
          en: "Trade ordinary phrasing for the refined word combinations that make you sound like a native, polished professional.",
          de: "Tausche gewöhnliche Formulierungen gegen die feinen Wortkombinationen, die einen versierten, muttersprachlichen Klang ausmachen.",
          fr: "Remplacez les tournures ordinaires par les combinaisons raffinées qui donnent un ton natif et soigné.",
          es: "Cambia las frases comunes por las combinaciones refinadas que dan un tono nativo y pulido.",
          sv: "Byt ut vardagliga uttryck mot de förfinade ordkombinationer som får dig att låta som en naturligt polerad talare.",
        },
      },
    ],
  },
