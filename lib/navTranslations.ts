  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        descriptions: {
          en: "Elevate your professional language — trade everyday phrasing for the refined word combinations polished speakers reach for.",
          de: "Werte deine berufliche Ausdrucksweise auf — tausche Alltagsformulierungen gegen die feinen Wortkombinationen versierter Sprecher.",
          fr: "Élevez votre langage professionnel — remplacez les tournures courantes par les combinaisons raffinées des orateurs aguerris.",
          es: "Eleva tu lenguaje profesional — cambia las frases comunes por las combinaciones refinadas de los oradores expertos.",
          sv: "Höj din professionella språknivå — byt vardagliga uttryck mot de förfinade ordkombinationer skickliga talare använder.",
        },
      },
    ],
  },
